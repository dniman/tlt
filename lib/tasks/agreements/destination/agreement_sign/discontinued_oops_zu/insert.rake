namespace :agreements do
  namespace :destination do
    namespace :agreement_sign do
      namespace :discontinued_oops_zu do
        ...
        task :insert do |t|
          def stat_query
            ...
            manager.where(Destination.s_note[:code].eq('DISCONTINUED_OOPS_ZU'))
            manager.to_sql
          end
          ...
          def query
            ...
            .where(Source.___agreements[:___docstate_name].eq('Прекращен, но земельный участок не возвращен'))
          end
