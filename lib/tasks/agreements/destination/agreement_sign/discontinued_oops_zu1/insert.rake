namespace :agreements do
  namespace :destination do
    namespace :agreement_sign do
      namespace :discontinued_oops_zu1 do
        ...
        task :insert do |t|
          def stat_query
            ...
            manager.where(Destination.s_note[:code].eq('DISCONTINUED_OOPS_ZU1'))
            manager.to_sql
          end
          ...
          def query
            ...
            .where(Source.___agreements[:___docstate_name].eq('Прекращен, но участок не м.б. истребован'))
          end
