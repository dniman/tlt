namespace :paycards do
  namespace :import do
    ...
    task :tasks do
      ...
      Rake.invoke_task 'paycards:source:___paycards:update_su_m'
      Rake.invoke_task 'paycards:source:___paycards:update_de_m'
      Rake.invoke_task 'paycards:source:___paycards:update_su_t'
      Rake.invoke_task 'paycards:source:___paycards:update_de_t'
      Rake.invoke_task 'paycards:source:___paycards:update_su_d2'
      Rake.invoke_task 'paycards:source:___paycards:update_de_d2'
