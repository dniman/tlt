      ...
      namespace :___ids do
        ...
        task :insert do |t|
          ...
          def query
            ...
            .join(Source.sharetypes, Arel::Nodes::OuterJoin).on(Source.sharetypes[:id].eq(Source.objshares[:sharetypes_id]))
            .where(Source.objtypes[:name].eq('Пакеты акций, доли в капитале')
