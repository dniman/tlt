  ...
  namespace :houses_unlife do
    namespace :import do
      ...
      task :tasks do 
        ...
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:add___owner_pay_acc_capital_repair' 
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:add___mkd_code' 

        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:add___kadastrno'
        Rake.invoke_task 'objects:houses_unlife:source:___ids:add___link_adr'
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:insert'
        Rake.invoke_task 'objects:houses_unlife:source:___ids:update_link'
        Rake.invoke_task 'objects:houses_unlife:source:___ids:update___link_adr'
        ...
        Rake.invoke_task 'objects:houses_unlife:source:___ids:drop___link_adr'

        # История адреса
        Rake.invoke_task 'objects:houses_unlife:source:___ids:add___add_hist'
        Rake.invoke_task 'objects:houses_unlife:source:___ids:update___add_hist'
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:add_hist:insert'
        Rake.invoke_task 'objects:houses_unlife:source:___ids:drop___add_hist'
        
        # История наименования
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:obj_name_hist:insert'
        
        # Официальный адрес
        Rake.invoke_task 'objects:houses_unlife:source:___ids:add___adr_str'
        Rake.invoke_task 'objects:houses_unlife:source:___ids:update___adr_str'
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:adr_str:insert'
        Rake.invoke_task 'objects:houses_unlife:source:___ids:drop___adr_str'
        ...
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:kadastr_price:insert'
        
        # Первоначальная стоимость
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:price_first:insert'
        
        # Остаточная стоимость
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:price_remain:insert'

        # Процент износа 
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:iznos:insert'

        # Состояние
        Rake.invoke_task 'objects:houses_unlife:source:states:add___link_state' 
        Rake.invoke_task 'objects:houses_unlife:source:states:update___link_state' 
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:state:insert'
        Rake.invoke_task 'objects:houses_unlife:source:states:drop___link_state' 
        ...
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:add___link_owner_pay_acc_capital_repair' 
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:update___link_owner_pay_acc_capital_repair' 
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:owner_pay_acc_capital_repair:insert'
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:drop___owner_pay_acc_capital_repair' 
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:drop___link_owner_pay_acc_capital_repair' 
        
        # Код МКД по рег программе 
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:add___link_mkd_code' 
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:update___link_mkd_code' 
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:mkd_code:insert'
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:drop___mkd_code' 
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects:drop___link_mkd_code' 
        
        # Дата включения в региональную программу
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:date_inclusion_rp:insert'
        
        # Дата изменения держателя счета
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:date_change_acc_holder:insert'
        
        # Документ основания изменения держателя счета
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_app:link_param:doc_reason_chang_acc_holder:insert'
        
        # Земельные участки, в пределах которого находится объект
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_parentland:insert'
        
        # Составные части объекта
        Rake.invoke_task 'objects:houses_unlife:destination:mss_objects_struelem:insert'
        
        # Привязка документов
        Rake.invoke_task 'objects:houses_unlife:source:___ids:add___link_list'
        Rake.invoke_task 'objects:houses_unlife:source:___ids:update___link_list'
        Rake.invoke_task 'objects:houses_unlife:destination:mss_detail_list:insert'
        Rake.invoke_task 'objects:houses_unlife:source:___ids:drop___link_list'
      end 
