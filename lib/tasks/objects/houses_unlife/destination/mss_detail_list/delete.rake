  ...
  namespace :houses_unlife do
    namespace :destination do
      namespace :mss_detail_list do
        ...
        task :delete do |t|
          def query
            condition1 = Destination.mss_detail_list.create_on(Destination.mss_objects[:link_list].eq(Destination.mss_detail_list[:link_list]))
            ...
            source = Arel::Nodes::JoinSource.new(
              Destination.mss_detail_list, [
                Destination.mss_detail_list.create_join(Destination.mss_objects, condition1),
