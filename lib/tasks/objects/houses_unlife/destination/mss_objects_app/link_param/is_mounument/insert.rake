          ...
          namespace :is_monument do
            ...
            task :insert do |t|
              ...
              def query
                ...
                manager.where(union_table[:is_monument].not_eq(nil))
              end

              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('IS_MONUMENT').to_sql).entries.first["link"]
