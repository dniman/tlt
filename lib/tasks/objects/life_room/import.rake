namespace :objects do
  namespace :life_room do
    namespace :import do
      ...
      task :tasks do 
        Rake.invoke_task 'objects:life_room:source:ids:insert'
        ...
        Rake.invoke_task 'objects:life_room:source:ids:add___link_adr'
        Rake.invoke_task 'objects:life_room:destination:mss_objects:insert'
        Rake.invoke_task 'objects:life_room:source:ids:update_link'
        Rake.invoke_task 'objects:life_room:source:ids:update___link_adr'
        ...
        Rake.invoke_task 'objects:life_room:source:ids:drop___link_adr'

        # История адреса
        Rake.invoke_task 'objects:life_room:source:ids:add___add_hist'
        Rake.invoke_task 'objects:life_room:source:ids:update___add_hist'
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:add_hist:insert'
        Rake.invoke_task 'objects:life_room:source:ids:drop___add_hist'
        
        # История наименования
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:obj_name_hist:insert'
        
        # Официальный адрес
        Rake.invoke_task 'objects:life_room:source:ids:add___adr_str'
        Rake.invoke_task 'objects:life_room:source:ids:update___adr_str'
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:adr_str:insert'
        Rake.invoke_task 'objects:life_room:source:ids:drop___adr_str'
        
        # Общая площадь
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:house_pl:insert'

        # ID объекта из Сауми
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:id_obj:insert'
        
        # Код ОКОФ
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:okof:insert'
        
        # Инвентарный номер 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:hous_inv_n:insert'
        
        # Год ввода в эксплуатацию 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:year_vvod:insert'
        
        # Дата ввода в эксплуатацию 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:house_date_begin_use:insert'
        ...
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:house_wall_type:insert'
        ...
        # Литера БТИ 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:bti_liter:insert'
        ...
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:is_immovable:insert'
        ...
        # Этажность
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:house_flats:insert'
        ...
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:wow_obj:insert'
        ...
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:soc_zn_obj:insert'
        ...
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:obj_zkx:insert'
        ...
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:vid_obj_zkx:insert'
        ...
        # Электроэнергия 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:blag_energ:insert'
        
        # Вода
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:blag_water:insert'

        # Газ 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:blag_gaz:insert'
        
        # Канализация 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:blag_kan:insert'
        
        # Лифт
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:blag_lift:insert'
        
        # Мусоропровод 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:blag_mus:insert'
        
        # Отопление 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:blag_hot:insert'
        
        # Телевидение 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:blag_tv:insert'
        
        # Телефонизация
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:blag_tel:insert'
        
        # Вентиляция
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:blag_vent:insert'
        
        # Памятник
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:is_monument:insert'
        ...
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:culturial_sense:insert'
        ...
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:name_monument:insert'
        
        # Дополнительная информация о памятнике
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:other_monument:insert'
        
        # Старый реестровый номер
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:rn_old:insert'
        
        # Примечание 
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:note_obj:insert'
        ...
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:unmovable_used:insert'
        ...
        # Жилая площадь
        Rake.invoke_task 'objects:life_room:destination:mss_objects_app:house_pl_gil:insert'
      end 
