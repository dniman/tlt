          ...
          namespace :blag_energ do
            ...
            task :insert do |t|
              ...
              def query
                ...
                manager.where(union_table[:bl_electric].not_eq(nil))
              end

              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('BLAG_ENERG').to_sql).entries.first["link"]
