    ...
    namespace :destination do
      namespace :mss_objects_app do
        namespace :link_param do
          namespace :doc_reason_chang_acc_holder do
            ...
            task :insert do |t|
              ...
              def query
                ...
                link_param = Destination.execute_query(link_param_query('DOC_REASON_CHANG_ACC_HOLDER').to_sql).entries.first["link"]

                Source.objects
                .project([
                  Source.buildings[:doc_pay_company],
                  Source.___ids[:link],
                ...
                .where(
                  ...
                  .and(Source.buildings[:doc_pay_company].not_eq(nil))
                )
              end
