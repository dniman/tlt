        ...
        namespace :blag_tv do
          ...
          task :insert do |t|
            ...
            def query
              ...
              manager.where(union_table[:bl_tv].not_eq(nil))
            end

            begin
              sql = ""
              insert = []
              link_param = Destination.execute_query(link_param_query('BLAG_TV').to_sql).entries.first["link"]
