    ...
    namespace :destination do
      namespace :mss_objects_app do
        namespace :link_param do
          namespace :mass_without_load do
            ...
            task :insert do |t|
              ...
              def query
                ...
                .where(Source.ids[:link_type].eq(link_type)
                  .and(Source.transport[:ps_weight].not_eq(nil))
                )
              end
              ...
              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('MASS_WITHOUT_LOAD').to_sql).entries.first["link"]
