  ...
  namespace :inland_waterway_vessel do
    namespace :import do
      ...
      task :tasks do 
        ...
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects:add___color_kuzov' 
        ...
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects:add___auto_country_export' 
        ...
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:inland_waterway_vessel_reg_n:insert'
        
        # Номер двигателя
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:dvigat_num:insert'
        
        # Номер шасси(рамы) 
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:shassi_num:insert'
        ...
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:vin_num:insert'
        
        # Цвет кузова
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects:add___link_color_kuzov' 
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects:update___link_color_kuzov' 
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:color_kuzov:insert'
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects:drop___color_kuzov' 
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects:drop___link_color_kuzov' 
        ...
        # Страна вывоза
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects:add___link_auto_country_export' 
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects:update___link_auto_country_export' 
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:auto_country_export:insert'
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects:drop___auto_country_export' 
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects:drop___link_auto_country_export' 
        
        # Серия, номер ГТД
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:gdt_ser_num:insert'
        
        # Таможенные ограничения
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:auto_tam_ogr:insert'
        
        # Организация, выдавшая ПТС
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:auto_pts_org:insert'
        
        # Дата ПТС
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:data_pts:insert'
        
        # Отделение ГИБДД
        Rake.invoke_task 'objects:inland_waterway_vessel:destination:mss_objects_app:ps_gibdd:insert'
      end 
