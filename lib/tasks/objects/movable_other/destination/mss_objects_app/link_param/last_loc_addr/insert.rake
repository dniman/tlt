          ...
          namespace :last_loc_addr do
            ...
            task :insert do |t|
              ...
              def query
                ...
                Source.objects
                .project([
                  Source.___ids[:___last_loc_addr],
                ...
                .where(Source.___ids[:link_type].eq(link_type)
                  .and(Source.___ids[:___last_loc_addr].not_eq(nil))
                )
              end
              ...
              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('LAST_LOC_ADDR').to_sql).entries.first["link"]
