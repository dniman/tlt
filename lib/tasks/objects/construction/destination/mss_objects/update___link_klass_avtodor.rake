  ...
  namespace :construction do
    namespace :destination do
      namespace :mss_objects do
        ...
        task :update___link_klass_avtodor do |t|
          ...
          begin
            ...
            update = [ 
              ___link_klass_avtodor: Arel.sql(
                "(
                  select link 
                  from mss_objects_dicts 
                  where name = mss_objects.___klass_avtodor
                    and mss_objects_dicts.link_dict = #{ link_param }
                )"
              )
            ]
            where = Arel.sql("mss_objects.___klass_avtodor is not null")
