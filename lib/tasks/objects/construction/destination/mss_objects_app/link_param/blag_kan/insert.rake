          ...
          namespace :blag_kan do
            ...
            task :insert do |t|
              ...
              def query
                ...
                manager.where(union_table[:bl_drain].not_eq(nil))
              end

              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('BLAG_KAN').to_sql).entries.first["link"]
