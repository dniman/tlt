          ...
          namespace :built_up_area do
            ...
            task :insert do |t|
              ...
              def query
                ...
                manager.where(union_table[:square_dev].not_eq(nil))
              end

              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('BUILT_UP_AREA').to_sql).entries.first["link"]
