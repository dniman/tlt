          ...
          namespace :blag_vent do
            ...
            task :insert do |t|
              ...
              def query
                ...
                manager.where(union_table[:bl_vent].not_eq(nil))
              end

              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('BLAG_VENT').to_sql).entries.first["link"]
