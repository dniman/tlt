          ...
          namespace :house_flats do
            ...
            task :insert do |t|
              ...
              def query
                ...
                manager.where(union_table[:floorcount].not_eq(nil))
              end

              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('HOUSE_FLATS').to_sql).entries.first["link"]
