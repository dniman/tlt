        ...
        namespace :other_monument do
          ...
          task :insert do |t|
            ...
            def query
              ...
              query = 
                ...
                .where(Source.ids[:link_type].eq(link_type)
                  .and(Source.objects[:mn_memo].not_eq(nil))
                )
            end
            ...
            begin
              sql = ""
              insert = []
              link_param = Destination.execute_query(link_param_query('OTHER_MONUMENT').to_sql).entries.first["link"]
