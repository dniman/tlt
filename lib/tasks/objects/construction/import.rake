namespace :objects do
  namespace :construction do
    namespace :import do
      ...
      task :tasks do
        Rake.invoke_task 'objects:construction:source:___ids:insert', 'UNDELETABLE'
        ...
        Rake.invoke_task 'objects:construction:source:___ids:add___link_adr'
        Rake.invoke_task 'objects:construction:destination:mss_objects:insert'
        Rake.invoke_task 'objects:construction:source:___ids:update_link'
        Rake.invoke_task 'objects:construction:source:___ids:update___link_adr'
        ...
        Rake.invoke_task 'objects:construction:source:___ids:drop___link_adr'
        
        # История адреса
        Rake.invoke_task 'objects:construction:source:___ids:add___add_hist'
        Rake.invoke_task 'objects:construction:source:___ids:update___add_hist'
        Rake.invoke_task 'objects:construction:destination:mss_objects_app:link_param:add_hist:insert'
        Rake.invoke_task 'objects:construction:source:___ids:drop___add_hist'
        
        # История наименования
        Rake.invoke_task 'objects:construction:destination:mss_objects_app:link_param:obj_name_hist:insert'
        
        # Официальный адрес
        Rake.invoke_task 'objects:construction:source:___ids:add___adr_str'
        Rake.invoke_task 'objects:construction:source:___ids:update___adr_str'
        Rake.invoke_task 'objects:construction:destination:mss_objects_app:link_param:adr_str:insert'
        Rake.invoke_task 'objects:construction:source:___ids:drop___adr_str'
        ...
        # Состояние
        Rake.invoke_task 'objects:construction:source:states:add___link_state' 
        Rake.invoke_task 'objects:construction:source:states:update___link_state' 
        Rake.invoke_task 'objects:construction:destination:mss_objects_app:link_param:state:insert'
        Rake.invoke_task 'objects:construction:source:states:drop___link_state' 
        ...
        Rake.invoke_task 'objects:construction:destination:mss_objects_parentland:insert'

        # Привязка документов
        Rake.invoke_task 'objects:construction:source:___ids:add___link_list'
        Rake.invoke_task 'objects:construction:source:___ids:update___link_list'
        Rake.invoke_task 'objects:construction:destination:mss_detail_list:insert'
        Rake.invoke_task 'objects:construction:source:___ids:drop___link_list'
      end 
    end
