      ...
      namespace :mss_objects_parentland do
        ...
        task :insert do |t|
          ...
          def query
            ...
            build_manager.where(
              Source.ids[:table_id].eq(Source::Objects.table_id)
                .and(Source.ids[:link_type].eq(link_unfinished_type))
            )
            ...
            unconstr_manager.from(Source.ids)
            unconstr_manager.join(Source.unconstr).on(Source.unconstr[:objects_id].eq(Source.ids[:id]))
