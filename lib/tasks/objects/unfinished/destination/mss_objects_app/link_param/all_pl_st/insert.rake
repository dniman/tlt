            ...
            task :insert do |t|
              ...
              def query
                ...
                Source.set_engine!
                  ...
                  Source.objects
                  .project([
                    Source.unconstr[:buildingsquare],
                    Source.ids[:link],
                  ...
                  .where(Source.ids[:link_type].eq(link_type)
                    .and(Source.unconstr[:buildingsquare].not_eq(nil))
                  )
              end
              ...
              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('ALL_PL_ST').to_sql).entries.first["link"]
