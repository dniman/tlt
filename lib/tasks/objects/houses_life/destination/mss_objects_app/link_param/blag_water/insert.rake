          ...
          namespace :blag_water do
            ...
            task :insert do |t|
              ...
              def query
                ...
                manager.where(union_table[:bl_water].not_eq(nil))
              end

              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('BLAG_WATER').to_sql).entries.first["link"]
