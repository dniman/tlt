  ...
  namespace :houses_life do
    namespace :destroy do
      task :tasks => [
        ...
        # Процент износа
        'objects:houses_life:destination:mss_objects_app:link_param:iznos:delete',
        
        # Состояние
        'objects:houses_life:destination:mss_objects_app:link_param:state:delete',
        ...
        'objects:houses_life:destination:mss_objects_app:link_param:owner_pay_acc_capital_repair:delete',

        # Код МКД по рег программе 
        'objects:houses_life:destination:mss_objects_app:link_param:mkd_code:delete',
        
        # Дата включения в региональную программу
        'objects:houses_life:destination:mss_objects_app:link_param:date_inclusion_rp:delete',
        
        # Дата изменения держателя счета
        'objects:houses_life:destination:mss_objects_app:link_param:date_change_acc_holder:delete',
        
        # Документ основания изменения держателя счета
        'objects:houses_life:destination:mss_objects_app:link_param:doc_reason_chang_acc_holder:delete',
        ...
        'objects:houses_life:source:___ids:drop___link_list',
        ...
        'objects:houses_life:source:states:drop___link_state',
        'objects:houses_life:destination:mss_objects:drop___owner_pay_acc_capital_repair',
        'objects:houses_life:destination:mss_objects:drop___link_owner_pay_acc_capital_repair',
        'objects:houses_life:destination:mss_objects:drop___mkd_code',
        'objects:houses_life:destination:mss_objects:drop___link_mkd_code',
      ]
    end
  end
end
