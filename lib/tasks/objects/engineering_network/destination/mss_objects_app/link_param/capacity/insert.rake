          ...
          namespace :capacity do
            ...
            task :insert do |t|
              ...
              def query
                ...
                manager.where(union_table[:volume].not_eq(nil))
              end

              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('CAPACITY').to_sql).entries.first["link"]
