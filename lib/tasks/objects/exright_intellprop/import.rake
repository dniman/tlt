  ...
  namespace :exright_intellprop do
    namespace :import do
      ...
      task :tasks do 
        ...
        Rake.invoke_task 'objects:exright_intellprop:destination:mss_objects_app:obj_name_hist:insert'
        
        # ID объекта из Сауми
        Rake.invoke_task 'objects:exright_intellprop:destination:mss_objects_app:id_obj:insert'
        
        # Старый реестровый номер
        Rake.invoke_task 'objects:exright_intellprop:destination:mss_objects_app:rn_old:insert'
        
        # Примечание 
        Rake.invoke_task 'objects:exright_intellprop:destination:mss_objects_app:note_obj:insert'
        ...
        #Rake.invoke_task 'objects:exright_intellprop:destination:mss_objects_app:dict_name:insert'
        ...
        #Rake.invoke_task 'objects:exright_intellprop:destination:mss_objects_app:group:insert'
        ...
        #Rake.invoke_task 'objects:exright_intellprop:destination:mss_objects_app:section:insert'
