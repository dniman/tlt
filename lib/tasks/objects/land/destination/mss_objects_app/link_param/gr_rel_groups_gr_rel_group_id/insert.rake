              ...
              def query
                ...
                query = 
                  ...
                  .project([
                    ...
                    Destination.mss_objects[:___link_gr_rel_groups_gr_rel_group_id],
                  ])
                  ...
                  .where(Destination.mss_objects[:link_type].eq(link_type)
                    .and(Destination.mss_objects[:___link_gr_rel_groups_gr_rel_group_id].not_eq(nil))
                  )
              end
                ...
                sliced_rows.each do |rows|
                  rows.each do |row|
                    insert << {
                      ...
                      link_dict: row["___link_gr_rel_groups_gr_rel_group_id"]
                    }
                  end
