  ...
  namespace :land do
    namespace :destination do
      namespace :mss_objects do
        ...
        task :update___link_unmovable_used_new do |t|
          ...
          begin
            ...
            update = [ 
              ___link_unmovable_used_new: Arel.sql(
                "(
                  select link 
                  from mss_objects_dicts 
                  where name = mss_objects.___unmovable_used_new
                    and mss_objects_dicts.link_dict = #{ link_param }
                )"
              )
            ]
            where = Arel.sql("mss_objects.___unmovable_used_new is not null")
