          ...
          task :insert do |t|
            ...
            def query
              ...
              .where(Source.ids[:link_type].eq(link_type)
                .and(Source.transport[:chassisno].not_eq(nil))
              )
            end
            ...
            begin
              sql = ""
              insert = []
              link_param = Destination.execute_query(link_param_query('SHASSI_NUM').to_sql).entries.first["link"]
