            ...
            task :insert do |t|
              ...
              def query
                ...
                .where(Source.ids[:link_type].eq(link_type)
                  .and(Source.transport[:ps_vin].not_eq(nil))
                )
              end
              ...
              begin
                sql = ""
                insert = []
                link_param = Destination.execute_query(link_param_query('VIN_NUM').to_sql).entries.first["link"]
