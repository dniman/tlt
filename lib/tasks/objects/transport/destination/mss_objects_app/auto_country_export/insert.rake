          ...
          task :insert do |t|
            ...
            def query
              ...
              .project([
                ...
                Destination.mss_objects[:___link_auto_country_export],
              ])
              ...
              .where(Destination.mss_objects[:link_type].eq(link_type)
                .and(Destination.mss_objects[:___link_auto_country_export].not_eq(nil))
              )
            end
              ...
              sliced_rows.each do |rows|
                rows.each do |row|
                  insert << {
                    ...
                    link_dict: row["___link_auto_country_export"]
                  }
                end
