  ...
  namespace :transport do
    namespace :import do
      ...
      task :tasks do 
        ...
        # Привязка документов
        Rake.invoke_task 'objects:transport:source:___ids:add___link_list'
        Rake.invoke_task 'objects:transport:source:___ids:update___link_list'
        Rake.invoke_task 'objects:transport:destination:mss_detail_list:insert'
        Rake.invoke_task 'objects:transport:source:___ids:drop___link_list'
      end 
