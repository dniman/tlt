          ...
          task :insert do |t|
            def query
              ...
              .project([
                ...
                Source.cls_kbk[:___link_income],
              ])
              .where(Source.cls_kbk[:___link_kbk_inc].not_eq(nil)
                .and(Source.cls_kbk[:___link_income].not_eq(nil))
              )
            end
            ...
            begin
              ...
              sliced_rows.each do |rows|
                rows.each do |row|
                  insert << {
                    ...
                    object: Destination::TKbk::REF_INC,
                    ref2: row["___link_income"],
                  }
                end
              end
              ...
              condition =<<~SQL
                t_kbk.ref1 = values_table.ref1
                  and t_kbk.object = #{ Destination::TKbk::REF_INC }
