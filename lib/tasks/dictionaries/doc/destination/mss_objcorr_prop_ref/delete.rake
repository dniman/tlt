namespace :dictionaries do
  namespace :doc do
    namespace :destination do
      namespace :mss_objcorr_prop_ref do
        ...
        task :delete do |t|
          ...
          begin
            ...
            manager.from (Destination.mss_objcorr_prop_ref)
            manager.where(Arel::Nodes::In.new(Destination.mss_objcorr_prop_ref[:link_type], subquery))
