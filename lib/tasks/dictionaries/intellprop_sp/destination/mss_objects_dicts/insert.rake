      ...
      namespace :mss_objects_dicts do
        ...
        task :insert do |t|
          ...
          def query
            ...
            .project([
              Source.intellectualtypes[:name],
            ])
            .distinct
            .where(Source.intellectualtypes[:name].not_eq(nil))
          end

          begin
            link_dict = Destination.execute_query(link_param_query('INTELLPROP_SP').to_sql).entries.first["link"]
