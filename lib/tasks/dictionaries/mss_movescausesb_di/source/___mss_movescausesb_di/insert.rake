      ...
      namespace :___mss_movescausesb_di do
        ...
        task :insert do |t|
          def query
            ...
            .where(Source.movetype[:name].not_in(['Списание', 'Ликвидация']))
          end
          ...
          begin
            ...
            Source.execute_query(query.to_sql).each_slice(1000) do |rows|
              ...
              sql = Source::MssMovescausesbDi.insert_query(rows: insert, condition: "___mss_movescausesb_di.name = values_table.name")
