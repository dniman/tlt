...
namespace :dictionaries do
  namespace :dictionary_nazn_rent do
    task :import do
      Rake.invoke_task 'dictionaries:dictionary_nazn_rent:source:___ids:insert', 'UNDELETABLE'
    ...
    task :destroy => [
      'dictionaries:dictionary_nazn_rent:destination:___del_ids:insert',
      'dictionaries:dictionary_nazn_rent:destination:s_nazn:delete',
      'dictionaries:dictionary_nazn_rent:destination:___del_ids:delete',
    ]
  end
end
