            ...
            def query
              ...
              varchar =
                Arel::Nodes::Addition.new(
                  Arel::Nodes::Addition.new(Arel.sql("'<varchar>'"), Destination.s_corr_app[:value]), Arel.sql("'</varchar>'")
                )
              ...
              select_manager.where(
                Destination.s_corr_app[:object].eq(Destination::SCorrApp::REFERENCE_POSTAL_ADDRESS)
