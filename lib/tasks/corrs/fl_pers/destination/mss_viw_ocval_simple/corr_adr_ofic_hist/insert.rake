          ...
          task :insert do |t|
            ...
            def query
              ...
              select_manager.where(
                ...
                .and(Destination.s_corr_app[:object].eq(Destination::SCorrApp::COLUMN_DICT_CORR_ADDRESS))
