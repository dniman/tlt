          ...
          task :insert do |t|
            ...
            def query
              ...
              .where(Source.client_types[:name].eq('Физическое лицо')
                .and(Source.clients[:id].not_eq(nil))
              )
            end
            ...
            begin
              ...
              condition =<<~SQL
                mss_viw_ocval_scorrapp.link_app_up = values_table.link_app_up
                  ...
                  and mss_viw_ocval_scorrapp.int = values_table.int
              SQL
