          ...
          task :insert do |t|
            ...
            def query
              ...
              .project([
                ...
                Source.organisations[:accountant].as("varchar"),
              ])
              ...
              .where(Source.client_types[:name].eq('Юридическое лицо')
                .and(Source.organisations[:accountant].not_eq(nil))
              )
            end
