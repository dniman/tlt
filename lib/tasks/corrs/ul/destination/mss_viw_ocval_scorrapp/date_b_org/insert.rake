          ...
          task :insert do |t|
            ...
            def query
              ...
              .project([
                ...
                Source.clients[:exists_since].as("datetime"),
              ])
              ...
              .where(Source.client_types[:name].eq('Юридическое лицо')
                .and(Source.clients[:exists_since].not_eq(nil))
              )
            end
