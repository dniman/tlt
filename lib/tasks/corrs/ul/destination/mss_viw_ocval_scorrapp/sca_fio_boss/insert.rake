          ...
          task :insert do |t|
            ...
            def query
              ...
              .project([
                ...
                Source.organisations[:director].as("varchar"),
              ])
              ...
              .where(Source.client_types[:name].eq('Юридическое лицо')
                .and(Source.organisations[:director].not_eq(nil))
              )
            end
