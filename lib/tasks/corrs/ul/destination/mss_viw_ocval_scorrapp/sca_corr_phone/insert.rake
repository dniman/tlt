          ...
          task :insert do |t|
            ...
            def query
              ...
              .project([
                ...
                Source.clients[:mobil_phone].as("varchar"),
              ])
              ...
              .where(Source.client_types[:name].eq('Юридическое лицо')
                .and(Source.clients[:mobil_phone].not_eq(nil))
              )
            end
