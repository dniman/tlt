          ...
          task :insert do |t|
            ...
            def query
              ...
              .project([
                ...
                Source.organisations[:accphone].as("varchar"),
              ])
              ...
              .where(Source.client_types[:name].eq('Юридическое лицо')
                .and(Source.organisations[:accphone].not_eq(nil))
              )
            end
