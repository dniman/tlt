          ...
          task :insert do |t|
            ...
            def query
              ...
              .project([
                ...
                Source.organisations[:directorpost].as("varchar"),
              ])
              ...
              .where(Source.client_types[:name].eq('Юридическое лицо')
                .and(Source.organisations[:directorpost].not_eq(nil))
              )
            end
