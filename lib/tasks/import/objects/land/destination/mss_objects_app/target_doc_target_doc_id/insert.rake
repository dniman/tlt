            ...
            def query
              ...
              query = 
                ...
                .project([
                  ...
                  Destination.mss_objects[:___link_target_doc_target_doc_id],
                ])
                ...
                .where(Destination.mss_objects[:link_type].eq(link_type)
                  .and(Destination.mss_objects[:___link_target_doc_target_doc_id].not_eq(nil))
                )
            end
              ...
              sliced_rows.each do |rows|
                rows.each do |row|
                  insert << {
                    ...
                    link_dict: row["___link_target_doc_target_doc_id"]
                  }
                end
