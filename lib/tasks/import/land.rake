...
namespace :import do
  namespace :land do
    task :tasks => [
      ...
      'import:land:destination:mss_objects_dicts:link_dict:transition_rf_ms:insert',
      ...
      'import:land:destination:mss_objects_dicts:link_dict:land_used:insert',
      ...
      'import:land:destination:mss_objects_dicts:link_dict:grounds_release_release_id:insert',
      ...
      'import:land:destination:mss_objects_dicts:link_dict:target_doc_target_doc_id:insert',
