    ...
    namespace :___moving_operations do
      ...
      task :update___link_cause_e3 do |t|
        ...
        def query
          ...
          manager.where(Source.___moving_operations[:movetype_name].eq('Ликвидация'))
