namespace :moving_operations do
  namespace :source do
    namespace :___moving_operations do
      ...
      task :update___link_cause_e do |t|
        ...
        def query
          ...
          manager.project([
            Source.___ids[:id],
            ___ids2[:link].as("___link_cause_e"),
          ])
        ...
        begin
          sql = <<~SQL
            update ___moving_operations set 
              ___moving_operations.___link_cause_e = values_table.___link_cause_e
            from ___moving_operations
              join(
                #{ query }
              ) values_table(id, ___link_cause_e) on values_table.id = ___moving_operations.id
          SQL
